...
test.describe("Mobile Dashboard", () => {
  ...
  test("mobile dashboard renders large health gauge", async ({ page }) => {
    await page.goto(`${MC_URL}/`);
    await page.waitForLoadState("networkidle");
    // Mobile layout should show the health gauge prominently
    const gauge = page.locator("svg circle")
      .or(page.locator('[data-tour="health-gauge"]'));
