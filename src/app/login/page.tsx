    ...
    <div className="relative flex min-h-screen items-center justify-center bg-[#050510] px-4">
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-xs font-medium uppercase tracking-[0.2em] text-[#475569]">AI Governance Platform</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full rounded-xl border border-[#1a2a4a] bg-[#0d0d1a] px-4 py-3 text-white placeholder:text-[#475569] focus:border-[#00D47E]/50 focus:outline-none focus:ring-1 focus:ring-[#00D47E]/50 transition"
            />
          </div>
          ...
          <button
            ...
            className="w-full rounded-xl bg-[#00D47E] px-4 py-3 font-semibold text-[#050510] transition hover:bg-[#05c090] disabled:opacity-50 disabled:cursor-not-allowed active:scale-[0.98]"
          >
