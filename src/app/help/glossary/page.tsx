    ...
    <div>
      ...
      <div className="relative mb-6">
        ...
        <input
          ...
          className="w-full rounded-xl border border-[#1a2a4a] bg-[#0d0d1a] py-2.5 pl-10 pr-4 text-sm text-[#e2e8f0] placeholder-[#475569] outline-none transition focus:border-[#00D47E]/50 focus:ring-1 focus:ring-[#00D47E]/20"
        />
        {query && (
