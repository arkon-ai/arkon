            ...
            <section key={letter}>
              ...
              <div className="space-y-1.5">
                {terms.map((t) => (
                  <div
                    key={t.term}
                    className="relative card-hover rounded-xl border border-[#1E1E2A]/50 bg-[#111118]/40 px-4 py-3 transition hover:border-[#1E1E2A]"
                  >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="min-w-0 flex-1">
                        ...
                        <p className="mt-0.5 text-[12px] leading-relaxed text-[#8888A0]">
                          {t.definition}
                        </p>
                      </div>
                      {t.link && (
