    ...
    >
      ...
      <div className="relative z-10 flex items-start justify-between">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-1.5 text-2xl font-bold tracking-tight text-[#E4E4ED]" style={{ fontFamily: "var(--font-mono)" }}>
            {value}
          </p>
          {subtitle ? (
          ...
          {trend ? (
            ...
            >
              ...
              {trend.value} <span className="text-[#555566] font-normal">vs yesterday</span>
            </p>
          ) : null}
        </div>
