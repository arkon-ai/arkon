...
export function ClientDashboard() {
  ...
  return (
    <div className="space-y-6">
      {/* Welcome banner */}
      <div className="rounded-[16px] border border-[#1a2a4a] bg-[linear-gradient(135deg,rgba(0,212,126,0.04),rgba(0,212,126,0.04))] p-6">
          ...
          {data.agents.length === 0 ? (
            ...
            <div className="space-y-3">
              {data.agents.map((agent) => (
                <div key={agent.id} className="flex items-center gap-3 rounded-xl bg-[#050510] px-4 py-3">
          ...
          {data.infra_nodes.length === 0 ? (
            ...
            <div className="space-y-3">
              {data.infra_nodes.map((node) => (
                <div key={node.hostname} className="flex items-center gap-3 rounded-xl bg-[#050510] px-4 py-3">
