...
function typeIcon(type: string, severity: string) {
  switch (type) {
    ...
    case "approval":
      return <Inbox className="h-4 w-4 text-[#8b5cf6]" />;
    case "budget":
    ...
    case "intake":
      return <Inbox className="h-4 w-4 text-[#06d6a0]" />;
            ...
            <div className="flex items-center gap-1">
              {unreadCount > 0 ? (
                <button
                  ...
                  className="flex h-6 items-center gap-1 rounded-lg px-2 text-[10px] font-medium text-[#64748b] hover:text-[#06d6a0] transition"
