      ...
      >
        ...
        <div className="flex h-14 items-center justify-between border-b border-[#1E1E2A]/50 px-4">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg text-[#8888A0] transition hover:bg-white/[0.05] hover:text-[#8888A0]"
                ...
                <section>
                  ...
                  <ul className="space-y-1.5">
                    {help.tips.map((tip, i) => (
                      <li
                        key={i}
                        className="flex gap-2 text-[11px] leading-relaxed text-[#8888A0]"
                      >
