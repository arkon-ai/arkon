            ...
            {data.daily_trend.map((d) => {
              ...
              return (
                <div key={d.day} className="group relative flex flex-1 flex-col items-center">
                  ...
                  <div
                    className="w-full rounded-t bg-gradient-to-t from-[var(--accent-dim)] to-[var(--accent)] transition-all group-hover:from-[var(--accent)] group-hover:to-[var(--accent-hover)]"
