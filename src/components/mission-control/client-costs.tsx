  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="rounded-2xl border border-amber-500/20 bg-[#050510] p-4">
        ...
        <div className="rounded-2xl border border-cyan-500/20 bg-[#050510] p-4">
        ...
        <div className="rounded-2xl border border-[#00D47E]/20 bg-[#050510] p-4">
      ...
      {data.by_agent.length > 0 ? (
        <div className="rounded-2xl border border-[#1a2a4a] bg-[#050510] p-5">
          ...
          <div className="space-y-2">
            {data.by_agent.map((a) => (
              <div key={a.agent_id} className="flex items-center justify-between rounded-xl bg-[#050510] px-4 py-3">
                <div>
        ...
        <div className="rounded-2xl border border-[#1a2a4a] bg-[#050510] p-5">
          ...
          <div className="space-y-3">
            {data.budgets.map((b, i) => {
              ...
              return (
                <div key={i} className="rounded-xl bg-[#050510] px-4 py-3">
