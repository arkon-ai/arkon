...
/**
 * Shared API-keys management UI — shell-agnostic. Rendered inside the owner
 * chrome (NotionShell) at /api-keys and inside the client portal (ClientShell)
 * at /client/api-keys. The /api/client/api-keys endpoint is owner-aware:
 * owners with the "All Tenants" wildcard see every key (creation then needs a
 * specific tenant selected); a scoped session sees and manages its own tenant.
 */
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="t-h2 text-[var(--text-primary)]">
            API Keys
          </h1>
