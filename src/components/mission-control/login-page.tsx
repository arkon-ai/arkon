...
export default function LoginPage() {
  ...
  const inputClass = "w-full rounded-xl border border-[var(--border)] bg-[var(--bg-primary)] px-4 py-3 text-white placeholder:text-[var(--text-tertiary)] focus:border-[rgba(var(--ion-rgb),0.5)] focus:outline-none focus:ring-1 focus:ring-[rgba(var(--ion-rgb),0.5)] transition";
    ...
    <div className="flex min-h-screen items-center justify-center bg-[var(--bg-primary)] px-4">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-2xl border border-[rgba(var(--ion-rgb),0.25)] bg-[rgba(var(--ion-rgb),0.08)]">
        ...
        {mode === "magic" && magicSent && (
          <div className="space-y-4 text-center">
            <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-2xl bg-[rgba(var(--ion-rgb),0.08)]">
