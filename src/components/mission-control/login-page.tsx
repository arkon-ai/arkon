...
export default function LoginPage() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-[#05050f] px-4">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full rounded-xl border border-[#1a2a4a] bg-[#0a0a14] px-4 py-3 text-white placeholder:text-slate-500 focus:border-cyan-500/50 focus:outline-none focus:ring-1 focus:ring-cyan-500/50 transition"
            />
          </div>
