...
export function CommandPalette({
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-start justify-center pt-[min(20vh,160px)]">
      ...
      />
      <Command
        className="relative w-full max-w-lg overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--bg-surface)] shadow-[var(--shadow-overlay)]"
                ...
                {items.map((item) => {
                  ...
                  return (
                    <Command.Item
                      ...
                      className="flex w-full cursor-pointer items-center gap-3 rounded-xl px-3 py-2.5 text-left text-[13px] text-[var(--text-secondary)] transition data-[selected=true]:bg-[rgba(var(--ion-rgb),0.08)] data-[selected=true]:text-[var(--text-primary)]"
                    >
