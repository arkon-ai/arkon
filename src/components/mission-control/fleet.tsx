        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <div className="flex items-center gap-2">
              ...
              {isWarden ? (
                <span className="rounded-[var(--radius-sm)] border border-[rgba(var(--ion-rgb),0.35)] bg-[rgba(var(--ion-rgb),0.08)] px-2 py-0.5 font-mono text-[10px] font-medium uppercase tracking-[0.08em] text-[var(--accent)]">
                  governor
                </span>
              ) : null}
            </div>
