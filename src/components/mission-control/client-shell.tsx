    ...
    <div className="min-h-screen bg-[#050510] text-slate-200">
      <div className="flex min-h-screen">
        ...
        <div className="flex min-h-screen min-w-0 flex-1 flex-col">
          <header className="sticky top-0 z-40 border-b border-[#1a2a4a]/80 bg-[#050510]/95 backdrop-blur">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-50 border-t border-[#1a2a4a]/80 bg-[#050510]/95 backdrop-blur md:hidden">
