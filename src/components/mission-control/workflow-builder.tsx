...
const NODE_STYLES: Record<string, { bg: string; border: string; icon: string; accent: string }> = {
  "manual-trigger": { bg: "#1a1a2e", border: "#06d6a0", icon: "\u25B6", accent: "#06d6a0" },
  ...
  "notify":         { bg: "#1a1a2e", border: "#8b5cf6", icon: "\u2709", accent: "#8b5cf6" },
};
...
function ManualTriggerNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      ...
      <Handle type="source" position={Position.Bottom} className="!bg-[#06d6a0] !w-3 !h-3 !border-2 !border-[#0a0a14]" />
    </div>
  );
}
...
function NotifyNode({ data, selected }: NodeProps) {
  ...
  return (
    ...
    >
      <Handle type="target" position={Position.Top} className="!bg-[#8b5cf6] !w-3 !h-3 !border-2 !border-[#0a0a14]" />
      <div className="flex items-center gap-2 mb-1">
        <span style={{ color: s.accent }}>{s.icon}</span>
      ...
      <Handle type="source" position={Position.Bottom} className="!bg-[#8b5cf6] !w-3 !h-3 !border-2 !border-[#0a0a14]" />
    </div>
  );
}
      ...
      <div className="space-y-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-3 py-2 text-sm text-white focus:border-cyan focus:outline-none"
          />
        </div>
        ...
        {nodeType === "cron-trigger" && (
          <div>
            ...
            <input
              ...
              placeholder="*/5 * * * *"
              className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-3 py-2 text-sm text-white font-mono placeholder-slate-600 focus:border-cyan focus:outline-none"
            />
          ...
          <>
            <div className="grid grid-cols-3 gap-2">
              <div>
                ...
                <select
                  ...
                  className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-2 py-2 text-sm text-white focus:border-cyan focus:outline-none"
                >
                  <option>GET</option>
                  <option>POST</option>
                  <option>PUT</option>
            ...
            <div>
              ...
              <input
                ...
                className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-3 py-2 text-sm text-white placeholder-slate-600 focus:border-cyan focus:outline-none"
              />
            </div>
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-3 py-2 text-sm text-white font-mono placeholder-slate-600 focus:border-cyan focus:outline-none resize-none"
              />
            </div>
          </>
        )}
          ...
          <>
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full rounded-lg border border-[#1a2a4a] bg-[#0a0a14] px-3 py-2 text-sm text-white placeholder-slate-600 focus:border-cyan focus:outline-none resize-none"
              />
            </div>
          </>
        )}
  ...
  return (
    <div className="relative h-full w-full">
      ...
      >
        ...
        />
        <Controls className="!bg-[#0d0d1a] !border-[#1a2a4a] !shadow-lg [&>button]:!bg-[#0d0d1a] [&>button]:!border-[#1a2a4a] [&>button]:!text-slate-400 [&>button:hover]:!bg-[#1a1a2e]" />
