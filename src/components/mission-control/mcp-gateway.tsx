  ...
  return (
    <div className="space-y-6">
        ...
        <div className="rounded-2xl border border-[#1a2a4a] bg-[#0a0a14] p-5">
          ...
          <div className="space-y-2">
            {stats.by_server.map((s) => (
              <div key={s.server_id} className="flex items-center justify-between rounded-xl bg-[#05050f] px-4 py-3">
                <div>
        ...
        <div className="rounded-2xl border border-[#1a2a4a] bg-[#0a0a14] p-5">
          ...
          <div className="flex flex-wrap gap-2">
            {stats.by_method.map((m) => (
              <div key={m.mcp_method} className="rounded-lg border border-[#1a2a4a] bg-[#05050f] px-3 py-2">
      ...
      {stats && stats.recent_errors.length > 0 ? (
        <div className="rounded-2xl border border-red-500/20 bg-[#0a0a14] p-5">
      ...
      {!loading && stats && stats.summary.total_requests === 0 ? (
        <div className="rounded-2xl border border-[#1a2a4a] bg-[#0a0a14] p-8 text-center">
      ...
      {showConfig && config ? (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="mx-4 w-full max-w-xl rounded-2xl border border-[#1a2a4a] bg-[#0a0a14] p-6">
            ...
            <pre className="rounded-xl bg-[#05050f] border border-[#1a2a4a] p-4 text-xs text-slate-300 overflow-auto max-h-64 font-mono">
...
function StatCard({ label, value, accent }: { label: string; value: string | number; accent: string }) {
  ...
  return (
    <div className="rounded-2xl border border-[#1a2a4a] bg-[#0a0a14] p-3">
