    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <button
            onClick={loadConfig}
            className="rounded-lg bg-[#00D47E]/20 px-3 py-1.5 text-xs font-medium text-[#00D47E] hover:bg-[#00D47E]/30 transition"
          >
            Export Config
          </button>
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-7">
        ...
        <StatCard label="Total Data" value={formatBytes(s?.total_bytes ?? 0)} accent="accent" />
