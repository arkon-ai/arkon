...
export const pageMeta: Record<string, PageMeta> = {
  ...
  "/integrations/command":       { title: "Command",           description: "Run agent commands directly",                    group: "Respond" },
  "/integrations/approvals":     { title: "Approvals",         description: "Review pending agent requests",                  group: "Respond" },
  "/integrations/crons":         { title: "Cron Jobs",         description: "Scheduled automations and triggers",             group: "Respond" },
  "/integrations/agents-live":   { title: "Live Agents",       description: "Active agent sessions and real-time output",     group: "Respond" },
  "/workflows":           { title: "Workflows",         description: "Automate multi-step operations",                 group: "Respond" },
  "/integrations/tasks":         { title: "Tasks",             description: "Track action items and assignments",             group: "Respond" },
  ...
  "/integrations/docs":          { title: "Docs",              description: "Agent documentation and knowledge base",         group: "Configure" },
  "/integrations/mcp":           { title: "MCP Servers",       description: "Manage tool providers and connections",          group: "Configure" },
  "/integrations/intake":        { title: "Client Intake",     description: "Client onboarding forms and workflows",          group: "Configure" },
  "/integrations/calendar":      { title: "Calendar",          description: "Schedule and events",                            group: "Configure" },
